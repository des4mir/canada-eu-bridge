    ...
    <section id="invest" className="py-20 bg-slate-50 border-b border-slate-200 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-12">
          <div className="inline-flex flex-wrap items-center justify-center gap-1.5 px-3 py-1 rounded-full bg-blue-100 border border-blue-200 text-blue-800 text-xs font-semibold uppercase tracking-wider mb-3">
            ...
            {t.cetaBenefits.map((benefit, bIdx) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-4 text-xs font-semibold text-blue-700 hover:text-blue-900 inline-flex flex-wrap items-center justify-center gap-1"
                >
                  <Sparkles className="w-3.5 h-3.5" />
