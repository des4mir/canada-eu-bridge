              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <span className="text-sm font-semibold px-2.5 py-1 rounded-full bg-blue-50 text-blue-800 border border-blue-100">
                      {sec.stats}
                    </span>
                  </div>
        ...
        <div className="mt-10 bg-blue-900 text-white rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-md">
          ...
          <div className="flex flex-wrap gap-3 shrink-0">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-blue-800 hover:bg-blue-700 text-white font-semibold text-sm sm:text-base transition-all border border-blue-700"
            >
