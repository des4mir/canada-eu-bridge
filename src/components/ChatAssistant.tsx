...
export const ChatAssistant: React.FC<ChatAssistantProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-amber-50/90 border-b border-amber-200 px-3 py-1.5 flex items-start gap-2 text-sm text-amber-900">
      ...
      <div className="bg-white border-t border-slate-200 px-3 py-2">
        <div className="flex flex-wrap items-center gap-1.5 text-sm">
          <span className="text-slate-400 font-semibold uppercase text-sm mr-1">
          ...
          {QUICK_PROMPTS.slice(0, 4).map((qp, idx) => (
            <button
              ...
              disabled={isLoading}
              className="px-2.5 py-1 rounded-full bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 border border-slate-200 text-sm transition-colors disabled:opacity-50"
            >
